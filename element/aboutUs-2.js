            ...
            >
              <div className="section-head style-3">
                ...
                <h2 className="title m-b20">
                  We Have Creative Team To Build Your Website Better
                </h2>
                <p>
                  Proin laoreet leo vel enim gravida, at porttitor metus
                  ultricies. Cras eu velit enim. Vivamus blandit, dolor ut
                  aliquet rutrum, ex elit mattis sapien, non molestie felis
                  neque et nulla. Sed euismod turpis id nibh suscipit semper.
              ...
              <ul className="list-check primary m-b30">
                ...
                <li>
                  Aliquam pulvinar diam tempor erat pellentesque, accumsan
                  mauri.
                </li>
              </ul>
              <Link href="/about-us-2">
                <a className="btn btn-primary rounded-xl gradient">
                  Learn More
                </a>
              </Link>
            </div>
