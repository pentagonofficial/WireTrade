              ...
              >
                ...
                >
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Unique product researching method to find a winning
                      product according to investment and category. Source
                      product on targeted margins from Alibaba, 1688, and
                      in-ground sourcing agent in china.{" "}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Optimized amazon product listing by in-depth keyword
                      research and content writing techniques. Most highly
                      optimized content converts traffic into sales.{" "}
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Get more leads with Amazon sponsored campaigns, create a
                      profitable sales funnel with low CTR and High ROI, Start
                      from low-budget campaigns.{" "}
                    </p>
                  </div>
                </div>
              </div>
                ...
                >
                  ...
                  <div className="icon-content">
                    <h4 className="dlab-title">
                      Market Evaluation & Breakdown
                    </h4>
                    <p>
                      Complete Market breakdown with product sales forecast
                      finds a gap in the market as per on customer demand.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Once the product is hunted before jumping in the market
                      find the USP (Unique Selling Proposition) by complete
                      market analysis and customer demand which brings the
                      product to another level.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div className="icon-content">
                    ...
                    <p>
                      Providing customer support on amazon seller central.
                      Resolve customer issues answer the question to the
                      customer on time Fastest Response time.
                    </p>
                  </div>
                </div>
              </div>
