              ...
              >
                ...
                <ul className="nav navbar-nav navbar">
                  ...
                  <li className={`${open === "about" ? "open" : ""}`}>
                    ...
                    <ul className="sub-menu">
                      <li className={`${open === "aboutsub1" ? "open" : ""}`}>
                        <a onClick={() => setOpen("aboutsub1")}>
                      ...
                      <li className={`${open === "aboutsub2" ? "open" : ""}`}>
                        <a onClick={() => setOpen("aboutsub2")}>
                          Faq <i className="fa fa-angle-right"></i>
                        </a>
                        <ul className="sub-menu">
                          <Link href="/faq-1">
                            <a>Faq 1</a>
                      ...
                      <li className={`${open === "pricing" ? "open" : ""}`}>
                        <a onClick={() => setOpen("pricing")}>
                          Pricing Table <i className="fa fa-angle-right"></i>
                        </a>
                        <ul className="sub-menu">
                      ...
                      <li className={`${open === "team" ? "open" : ""}`}>
                        <a onClick={() => setOpen("team")}>
                          Team
                  ...
                  <li className={`${open === "services" ? "open" : ""}`}>
                    ...
                    <ul className="sub-menu">
                      ...
                      >
                        <a onClick={() => setOpen("servicedetails")}>
                          Services Details <i className="fa fa-angle-right"></i>
                        </a>
                        <ul className="sub-menu">
                          <Link href="/services-details-1">
                            <a>Services Details 1</a>
                          </Link>
                          <Link href="/services-details-2">
                            <a>Services Details 2</a>
                          </Link>
                          <Link href="/services-details-3">
                            <a>Services Details 3</a>
                          </Link>
                        </ul>
                      </li>
                    </ul>
                  ...
                  <li className={`${open === "blog" ? "open" : ""}`}>
                    ...
                    <ul className="sub-menu">
                      ...
                      <li>
                        <Link href="/blog-large-left-sidebar">
                          <a>Large Left Sidebar</a>
                        </Link>
                      </li>
                      <li>
                      ...
                      <li className={`${open === "blogdetail" ? "open" : ""}`}>
                        <a onClick={() => setOpen("blogdetail")}>
                          Blog Details <i className="fa fa-angle-right"></i>
                        </a>
                        <ul className="sub-menu">
                  ...
                  <li className={`${open === "contact" ? "open" : ""}`}>
                    <a onClick={() => setOpen("contact")}>
