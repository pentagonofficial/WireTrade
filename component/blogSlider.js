          ...
          >
            <div className="dlab-blog style-1 bg-white text-center">
              ...
              <div className="dlab-info">
                ...
                <p className="m-b0">
                  Pellentesque vel nibh gravida erat interdum lacinia vel in
                  lectus. Sed fermentum pulvinar.
                </p>
          ...
          >
            <div className="dlab-blog style-1 bg-white text-center">
              <div className="dlab-media">
                <Link href="/blog-details-1">
                  <a>
                    <img src="images/blog/blog-grid-1/pic2.jpg" alt="" />
                  </a>
                </Link>
              </div>
              <div className="dlab-info">
                <h5 className="dlab-title">
                  <Link href="/blog-details-1">
                    <a>Donec feugiat mollis nisi in dignissim. Morbi lectus.</a>
                  </Link>
                </h5>
                <p className="m-b0">
                  Pellentesque vel nibh gravida erat interdum lacinia vel in
